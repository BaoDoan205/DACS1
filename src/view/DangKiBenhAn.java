...
public class DangKiBenhAn extends JFrame {
	...
	private void init() {
		...
		JTextField jTextField_MaBN = new JTextField(25);
		JLabel jLabel_hoten = new JLabel("Họ Và Tên");
		JTextField jTextField_hoTen = new JTextField(25);
		JLabel jLabel_NgaySinh = new JLabel("Ngày Sinh");
		JTextField jTextField_ngaySinh = new JTextField(25);
		JLabel jLabel_loaibenh = new JLabel("Loại Bệnh");
		JTextField jTextField_loaibenh = new JTextField(25);
		JLabel jLabel_ngayNhapVien = new JLabel("Ngày Nhập Viện");
		JTextField jTextField_nhapvien = new JTextField(25);
		JLabel jLabel_ngayRaVien = new JLabel("Ngày Xuất Viện");
		JTextField jTextField_raVien = new JTextField(25);
		...
		JButton jButton_capnhat = new JButton("Xem");
		...
		JButton jButton_thoat = new JButton("Trở Lại");
		jButton_thoat.setIcon(
				new ImageIcon(Toolkit.getDefaultToolkit().createImage(MainView.class.getResource("return_icon.png"))));
		...
		jButton_thoat.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				int luaChon = JOptionPane.showConfirmDialog(DangKiBenhAn, "Bạn Muốn Trở Lại Trang Chủ", "YES",
						JOptionPane.YES_NO_OPTION);
				if (luaChon == JOptionPane.YES_NO_OPTION) {
					TrangchuBS trangchu = new TrangchuBS();
