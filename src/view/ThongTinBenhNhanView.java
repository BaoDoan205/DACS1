...
public class ThongTinBenhNhanView extends JFrame {
	...
	private void init() {
		...
		jTextField_id = new JTextField(30);
		JLabel jLabel_hoten = new JLabel("Họ tên Bệnh Nhân: ");
		jTextField_hoten = new JTextField(30);
		JLabel jLabel_ngaysinh = new JLabel("Ngày Sinh: ");
		jTextField_ngaysinh = new JTextField(30);
		...
		jTextField_tinh = new JTextField(30);
		JLabel jLabel_huyen = new JLabel("Quận/Huyện");
		jTextField_huyen = new JTextField(30);
		JLabel jLabel_xa = new JLabel("Xã/ Phường/ Thị Trấn");
		jTextField_xa = new JTextField(30);
		...
		jButton_thoat = new JButton("Trở Lại");
		jButton_thoat.addActionListener(action);
		jButton_thoat.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(MainView.class.getResource("return_icon.png"))));
...
//		});
	...
	public void thoatChuongTrinh_Xuli_Thoat() {
		int luaChon = JOptionPane.showConfirmDialog(this, "Bạn Muốn Trở Lại Trang Chủ", "YES",
